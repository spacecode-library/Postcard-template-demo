...
const BlastStep3 = () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.zipsWithData > 0) {
          toast.success(`${result.zipsWithData} ZIP code${result.zipsWithData !== 1 ? 's' : ''} with new movers!`, {
            id: 'validate-zips',
            duration: 3000
          });
  ...
  const handleContinue = () => {
    if (!canContinue()) {
      toast.error('Please validate ZIP codes with new movers');
      return;
    }
  ...
  return (
    <ProcessLayout
      ...
      footerMessage="Target new movers in the areas you want to reach"
    ...
    >
      ...
      <h1 className="process-title">Target New Movers</h1>
      <p className="process-subtitle">
        Enter ZIP codes to send your blast to new movers in these areas
      </p>
            ...
            <>
              ...
              <div className="results-section">
                ...
                <div className="validation-summary">
                  ...
                  >
                    ...
                    <div className="summary-content">
                      ...
                      <div className="summary-label">ZIP{zipValidation.zipsWithData !== 1 ? 's' : ''} with New Movers</div>
                    </div>
                  </motion.div>
                  ...
                  {zipValidation.zipsWithoutData > 0 && (
                    <div className="summary-card warning">
                      ...
                      <div className="summary-content">
                        ...
                        <div className="summary-label">No Data Available</div>
                      </div>
                    </div>
                  )}
                ...
                <div className="zip-status-section">
                  <h4 className="zip-status-title">ZIP Code Details</h4>
                    ...
                    {validatedZips.map((zip, index) => (
                      <div key={index} className={`zip-status-item ${zip.hasData ? 'has-data' : 'no-data'}`}>
                        ...
                        <div className="zip-status-label">
                          {zip.hasData ? 'New Movers Available' : 'No Data'}
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                {zipValidation.zipsWithData > 0 && (
                  <div className="results-footer">
                    ...
                    <span>Ready to send to {zipValidation.zipsWithData} ZIP code{zipValidation.zipsWithData !== 1 ? 's' : ''}</span>
                  </div>
                )}
              </div>
            </>
      ...
      <style jsx>{`
        /* Copy all styles from CampaignStep4.jsx */
        .blast-loading {
          display: flex;
          align-items: center;
